...
import CursoDistribucionSidebar from "@/components/CursoDistribucionSidebar";
    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="grid lg:grid-cols-[1fr_320px] gap-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between pt-8 border-t border-gray-200">
            <div>
              {anterior ? (
                <Link
                  href={`/curso-distribucion/leccion/${anterior.slug}`}
            ...
            <div>
              {siguiente ? (
                <Link
                  href={`/curso-distribucion/leccion/${siguiente.slug}`}
                  className="group inline-flex items-center gap-3 text-sm hover:text-gray-900 transition-colors"
                >
        ...
        <div className="lg:block hidden">
          <CursoDistribucionSidebar currentSlug={slug} />
        </div>
      </div>
    </div>
  );
