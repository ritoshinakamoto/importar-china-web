      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700 ml-8">
            <li>🔍 Template Due Diligence (60+ criterios)</li>
            <li>📊 Sistema de puntuación automático</li>
            <li>📄 Excel + PDF + Guías</li>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <ol className="space-y-3 text-sm text-gray-700">
            ...
            <li className="flex gap-3">
              ...
              <span>Descarga el template y evalúa tus proveedores</span>
            </li>
          </ol>
        </div>
        ...
        <Link
          href="/"
          className="block w-full bg-purple-600 text-white text-center font-bold py-3 rounded-lg hover:bg-purple-700 transition-colors mb-4"
        >
          Volver al Inicio
        </Link>
        ...
        <div className="text-center text-xs text-gray-500 border-t border-gray-200 pt-4">
          ...
          <a href="mailto:soporte@importardechina.com" className="text-purple-600 hover:underline">
