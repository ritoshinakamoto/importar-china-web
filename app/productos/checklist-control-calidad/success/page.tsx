      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700 ml-8">
            <li>✅ Checklist QC completo (80+ puntos)</li>
            <li>📄 PDF + Excel editable</li>
            <li>📖 Guía de uso profesional</li>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <ol className="space-y-3 text-sm text-gray-700">
            ...
            <li className="flex gap-3">
              ...
              <span>Descarga el checklist y úsalo en tu próxima inspección</span>
            </li>
          </ol>
        </div>
        ...
        <Link
          href="/"
          className="block w-full bg-green-600 text-white text-center font-bold py-3 rounded-lg hover:bg-green-700 transition-colors mb-4"
        >
          Volver al Inicio
        </Link>
        ...
        <div className="text-center text-xs text-gray-500 border-t border-gray-200 pt-4">
          ...
          <a href="mailto:soporte@importardechina.com" className="text-green-600 hover:underline">
