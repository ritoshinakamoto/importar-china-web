      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700 ml-8">
            <li>📄 15 plantillas de email en PDF</li>
            <li>📖 Guía completa de uso</li>
            <li>✨ Bonus: Checklist Validación Proveedores</li>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          ...
          <ol className="space-y-3 text-sm text-gray-700">
            ...
            <li className="flex gap-3">
              ...
              <span>Descarga el PDF y empieza a usar las plantillas</span>
            </li>
          </ol>
        </div>
        ...
        <Link
          ...
          className="block w-full bg-teal-600 text-white text-center font-bold py-3 rounded-lg hover:bg-teal-700 transition-colors mb-3"
        >
        ...
        <Link
          href="/"
          className="block w-full bg-gray-100 text-gray-700 text-center font-medium py-3 rounded-lg hover:bg-gray-200 transition-colors mb-4"
        >
          Volver al Inicio
        </Link>
        ...
        <div className="text-center text-xs text-gray-500 border-t border-gray-200 pt-4">
          ...
          <a href="mailto:soporte@importardechina.com" className="text-teal-600 hover:underline">
